...
t1 = 0; t2 = 15e-3; out = 3; % changed the t2 from 15e-9
h1 = 1e-6; h2 = 30e-6; h3 = 60e-6; % from e-12
...
xlabel('Time (mSec)','FontSize',20)
ylabel('Output Voltage (mV)','FontSize',20)
legend({'Forward Euler h=1muSec','Forward Eurler h=30muSec'},'FontSize',20);
...
xlabel('Time (mSec)','FontSize',20)
ylabel('Output Voltage (mV)','FontSize',20)
legend({'Forward Euler h=60muSec'},'FontSize',20) % was psec
